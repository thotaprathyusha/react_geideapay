...
import {
  defaultCreditCard,
  defaultCreditCardDate,
  defaultCreditCardCcv,
} from '../../../utils/formUtils'
import Text from '../CustomText'
import styles from './styles'

const CustomCreditCard = ({ name, number, expiry, cvc, rotate, cardColor }) => {
          ...
          <View>
            ...
            <View style={styles.secondSection}>
              ...
              <View>
                ...
                <Text style={styles.date}>{defaultCreditCardDate(expiry)}</Text>
              </View>
            </View>
          </View>
        ) : (
          <View>
            <View style={styles.ccvSection} />
